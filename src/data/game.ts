...
export const games: Game[] = [
  {
    ...
    category: "action-rpg",
    description:
      "Elden Ring is a fantasy action role-playing game developed by FromSoftware and published by Bandai Namco Entertainment. The game is set in a vast, dark fantasy world called the Lands Between, where players take on the role of a Tarnished, tasked with restoring the Elden Ring and becoming the Elden Lord. Players can explore the open world, battle challenging enemies, and interact with a rich cast of characters, all while defining their own playstyle through a variety of weapons, magic, and skills. ",
    image:
